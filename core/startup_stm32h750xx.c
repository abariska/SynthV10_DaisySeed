...
extern void *_sidtcm_data, *_sdtcm_data, *_edtcm_data;
...
void __attribute__((noreturn)) Reset_Handler()
{
	...
	for (pSource = &_sidtcm_data, pDest = &_sdtcm_data; pDest != &_edtcm_data; pSource++, pDest++)
		*pDest = *pSource;

	for (pSource = &_siitcm_text, pDest = &_sitcm_text; pDest != &_eitcm_text; pSource++, pDest++)
		*pDest = *pSource;

	for (pDest = &_sbss; pDest != &_ebss; pDest++)
		*pDest = 0;

	for (pDest = &_sdtcm_bss; pDest != &_edtcm_bss; pDest++)
		*pDest = 0;
